...
/**
 * Created by Alex Bulanov on 1/6/2018.
 */
@Autonomous(name="RedBBallNoBlock")
public class RedBBallNoBlock extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //Turn to 270
        if (opModeIsActive()) {
            if ((robot.imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES).firstAngle + 180) < 180) {
                rotateClockwise(360);
            }
            else if ((robot.imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES).firstAngle + 180) > 180) {
